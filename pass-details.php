...
<tr>
    ...
    <td>
    <img src="upload/<?php echo $row['Visitorphoto']; ?>" width="100px" height="100px">
    </td>
...
<tr>
  ...
  <tr>
    <th>Apartment Name 1</th>
    <td><?php  echo $row['ApartmentName1'];?></td>
    <th>Flat No</th>
    <td><?php  echo $row['Flat1'];?></td>
  </tr>
  <tr>
    <th>Apartment Name 2</th>
    <td><?php  echo $row['ApartmentName2'];?></td>
    <th>Flat No</th>
    <td><?php  echo $row['Flat2'];?></td>
  </tr>
  <tr>
    <th>From Date</th>
