...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into tblvisitor(categoryName,VisitorName,MobileNumber,Address,WhomtoMeet,ReasontoMeet,Apartment,Floor,VehicleNo) value('$catname','$visname','$mobnumber','$add','$whomtomeet','$reasontomeet','$apart','$floor','$VNo')");
...
<div class="col-12 col-md-9">
  <input type="text" id="visname" name="visname" placeholder="Visitor Name" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Apartment Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="apartment" id="apartment"  class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="floor" name="floor" placeholder="Flat No" class="form-control" required="true">
                                                    
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Vehicle No</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="VehicleNo" name="VehicleNo" placeholder="Vehicle No(MH**AB****) " class="form-control" required="true">
